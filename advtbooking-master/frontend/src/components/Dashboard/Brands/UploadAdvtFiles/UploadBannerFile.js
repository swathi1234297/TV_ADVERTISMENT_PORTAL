        ...
        backgroundRepeat: 'no-repeat' }}>
            <center>
                <Card style={{ width: '48rem', backgroundColor: '#919191' }}>
                    <Card.Body>
                        <Card.Title>Upload Banner</Card.Title>
                        <form encType="multipart/form-data" onSubmit={uploadImageInServer}>
                            <label for="bannerAdvtFile">Select Banner Advt:&nbsp;&nbsp;  </label>
                            <input type="file" id="bannerAdvtFile" name="bannerAdvtFile" accept="image/*,video/*" onChange={handleChange} />
...
export default UploadBannerFile
